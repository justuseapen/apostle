...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BVfNmahB.mjs");
...
var manifest = {
	"2c0ee7f5dc89f964216704d08b7fe844396306dd9528a3d7d00a4eb7c961bb90": {
		functionName: "getDesk_createServerFn_handler",
		importer: () => import("./server-ClyYorSi.mjs")
	},
	"347acb3da2232ebe1b59364bff6eb033ce203a304db172ccd20f6911b5658d11": {
		functionName: "sendMessage_createServerFn_handler",
		importer: () => import("./server-ClyYorSi.mjs")
	},
	"40bcbce2fd2261c7548578f140bfc6670822a4db6eab511804540d88305189ce": {
		functionName: "saveDesk_createServerFn_handler",
		importer: () => import("./server-ClyYorSi.mjs")
	},
	"617bd1ef418ac6cea1b4384016139dceae64f1fcda71e5fd08dea5cb0fc458dd": {
		functionName: "listMessages_createServerFn_handler",
		importer: () => import("./server-ClyYorSi.mjs")
	},
	"eebb5b508840a0f22beebf9f35ec1a12cc6113983a54f8961b43a1fd9af91cd3": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D9PDVpxs.mjs").then((n) => n.t),
